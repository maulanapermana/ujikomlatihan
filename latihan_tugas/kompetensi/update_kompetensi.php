...
$query = "UPDATE tbl_kompetensi SET kd_kompetensi = '$kd_kompetensi', nama_kompetensi = '$nama_kompetensi', 
prog_keahlian = '$prog_keahlian' WHERE kd_kompetensi = '$kd_kompetensi'";
